        ...
        <div className=" py-20 bg-shade min-h-[600px]">
           <div className="grid grid-col-reverse md:grid-cols-2 container mx-auto">
            <div className="content flex justify-center flex-col">
               <div>
                 <h2 className='text-5xl font-bold text-text leading-tight mb-3 mx-3'>Future ready with EduLearn</h2>
                <h2 className='text-5xl font-bold text-primary leading-tight mb-3 mx-3'>Enroll. Learn. Excel.</h2>
                <p className='text-lg mx-3'>Access all courses under one roof.
                    
                </p>

               </div>
                <div className="button my-5 mx-3">
